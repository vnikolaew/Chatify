...
import { PinIcon, PinOffIcon, useReplyToMessageContext } from "@web/components";
import CommentIcon from "../../icons/CommentIcon";
import ForwardIcon from "../../icons/ForwardIcon";
import { TooltipButton } from "../../common";
import ChatMessageMoreActionsButton from "./ChatMessageMoreActionsButton";
...
const ChatMessageActionsToolbar = ({
   ...
   }, [pinMessage, messageId, pinLoading, t, onOpenForwardMessageModal, onEditMessageChange, setReplyToMessage, pinnedMessages, unpinMessage, unpinLoading, showMoreActions]);
