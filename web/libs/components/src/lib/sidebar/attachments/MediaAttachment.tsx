...
import { downloadImage } from "@web/utils";
                    ...
                    {t.rich(`AttachmentDescription`,
                        {
                            ...
                            dateBold: (chunks) => <Chip as={`span`} className={`!text-[10px] h-[16px] ml-1 px-1 !py-0`} variant={`shadow`} color={`default`} size={`sm`} >{chunks}</Chip>,
                        })}
                </p>
            </div>
        </div>
