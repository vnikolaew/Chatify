...
export interface StartupRocketIconProps extends SVGProps<SVGSVGElement> {
   size: string | number;
}

const StartupRocketIcon = ({ size, fill, ...rest }: StartupRocketIconProps) => {
   return (
      <svg
         width={size}
         height={size}
...
export default StartupRocketIcon;
